/**
 * @file EspHal.h
 * @brief ESP32 Hardware Abstraction Layer for RadioLib
 *
 * Based on the RadioLib ESP-IDF example by Jan Gromes.
 * Provides SPI and GPIO abstraction for SX127x radio modules.
 */
